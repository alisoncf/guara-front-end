...
//$GLOBALS['configDb']['host'] = '10.20.60.32';
//$GLOBALS['configDb']['bd'] = "ueg_central";
//$GLOBALS['configDb']['login'] = 'sistema';
//$GLOBALS['configDb']['password'] = "hfaj%e78#";
